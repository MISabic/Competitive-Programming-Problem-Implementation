...
//ll inline lcm(ll a,ll b,ll c){return (((b/gcd(a,b))%c)*(a%c))%c;}
ll inline lcm(ll a,ll b){return b/gcd(a,b)*a;}
ll bigmod(ll a,ll b,ll m){if(!b){return 1LL%m;}if(b%2){return ((a%m)*bigmod(a,b-1,m))%m;}else {ll x=bigmod(a,b/2,m)%m;return (x*x)%m;}}
...
int main()
{
    ...
    cin.tie(0);
    ll t,r,a,b,d,z,p3,n3,con=0,k1,k2;
    cin>>t;
    while(t--){
        cin>>r>>a>>b>>d;
        ll x=(r/a);
